...
class AtualizacaoModel
{
    ...
    {
        $sql = 'INSERT INTO atualizacao (titulo, descricao, usuario_id) VALUES (:titulo, :descricao, :usuarioid)';
    ...
    {
        $sql = 'UPDATE atualizacao SET titulo = :titulo, descricao = :descricao WHERE id = :id';
    ...
    {
        $sql = 'SELECT id, titulo, descricao FROM atualizacao WHERE id = :id';
    ...
    {
        $sql = 'SELECT a.id, a.titulo, u.nome as usuario_nome FROM atualizacao a INNER JOIN usuario u ON u.id = a.usuario_id';
    ...
    private function collection(array $param): Atualizacao
    {
        ...
        $atualizacao->setTitulo($param['titulo'] ?? null);
        $atualizacao->setDescricao($param['descricao'] ?? null);

        $atualizacao->setUsuario(new Usuario(
