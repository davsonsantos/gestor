...
/**
 * Gerencia o acesso a tabela usuario
 */
class UsuarioModel
{
    ...
    public function insert(Usuario $usuario): int
    {
        ...
        $sql = 'INSERT INTO usuario (nome, usuario, senha, status, permissao, data) VALUES (:nome, :usuario, :senha, :status, :permissao, :data)';
     ...
     * @return bool Retorna TRUE se alterou e FALSE do contrário
     */
    public function update(Usuario $usuario): bool
    {
        $sql = 'UPDATE usuario SET nome = :nome, usuario = :usuario, status = :status, permissao = :permissao WHERE id = :id';
     ...
     * @return bool Retorna TRUE se existir e FALSE do contrário
     */
    public function checkUserAlredyExists(string $usuarioNome, int $usuarioId = -1): bool
    {
    ...
    {
        $sql = 'SELECT id, nome, usuario, status, permissao, data FROM usuario ORDER BY nome ASC';
    ...
    /**
     * Recebe um ID e retorna as informações de seu usuário
     *
    ...
    {
        $sql = 'SELECT id, nome, usuario, status, permissao FROM usuario WHERE id = :id';
