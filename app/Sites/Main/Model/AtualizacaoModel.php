...
class AtualizacaoModel
{
    ...
    {
        $sql = 'SELECT a.id, a.titulo, a.descricao, u.nome as usuario_nome FROM atualizacao a INNER JOIN usuario u ON u.id = a.usuario_id WHERE a.id = :id';
    ...
    {
        $sql = 'SELECT id, titulo, descricao FROM atualizacao ORDER BY id DESC LIMIT :limit';
    ...
    private function collection(array $param): array
    {
        return [
            ...
            'usuarioNome' => $param['usuario_nome'] ?? null
        ];
    }
}
