...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)},window.jQuery,window.Zepto));$(function(){BASE=$("link[rel='base']").attr("href");$('[data-toggle="tooltip"]').tooltip();if($('.mask').length){$.getScript(BASE+'/shared/common/js/jquery.mask.js',function(){$(".mask-date").mask('00/00/0000');$(".mask-datetime").mask('00/00/0000 00:00');$(".mask-month").mask('00/0000',{reverse:!0});$(".mask-doc").mask('000.000.000-00',{reverse:!0});$(".mask-card").mask('0000  0000  0000  0000',{reverse:!0});$(".mask-money").mask('000.000.000.000.000,00',{reverse:!0,placeholder:"0,00"});$('.mask-Phone').focusout(function(){var phone,element;element=$(this);element.unmask();phone=element.val().replace(/\D/g,'');if(phone.length>10){element.mask("(99) 99999-999?9")}else{element.mask("(99) 9999-9999?9")}}).trigger('focusout')})}
function readImage(){if(this.files&&this.files[0]){var file=new FileReader();file.onload=function(e){document.getElementById("preview").src=e.target.result};file.readAsDataURL(this.files[0])}}
document.getElementById("img-input").addEventListener("change",readImage,!1)})